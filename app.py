...
<div class="flex-container">
    <div class="flex-item introduction">
        <h2>What this is</h2>
        <p>This is a tool produced by HoloMed AI. It is an intelligent, user-friendly heart disease risk assessment platform that delivers personalized risk scores along with expert-backed health recommendations. Powered by cutting-edge AI models and real-world medical data, this tool simplifies complex diagnostics into clear, actionable insights. Whether you're a healthcare professional or an individual monitoring your health, this makes understanding and managing cardiovascular risk intuitive, accessible, and reliable</p>
    </div>
...
gender = row2_1.selectbox("What is your gender?", ["female", "male", "error button"], index=1)
if gender == 'error button':
    gender = 'nonbinary'
...
with row8_1:
    st.write("#### HoloMed AI Heart Disease Risk Assessment")
...
if btn1:
    try:
        ...
        with row8_1:
            ...
            feature_importances = np.abs(shap_array).sum(axis=0)
...
with row9_1.expander("Leave Us a Comment or Question"):
    contact_form = """
        <form action=https://formsubmit.co/mismailcheema08@gmail.com method="POST">
